...
<main class="main">
    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="container">
            <h2>Bem-vindo à Clínica Vida Plena</h2>
            <p>Oferecemos cuidado médico humanizado com excelência e tecnologia para promover saúde e bem-estar em todas as fases da vida.</p>
    ...
    <div class="container">
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <h4><a href="" class="stretched-link">Atendimento Humanizado</a></h4>
            <p>Priorizamos o acolhimento e a escuta ativa em cada consulta.</p>
            </div>
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4><a href="" class="stretched-link">Medicamentos e Tratamentos</a></h4>
            <p>Contamos com farmacêuticos especializados e prescrição segura.</p>
            </div>
        </div><!-- End Service Item -->
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            ...
            <h4><a href="" class="stretched-link">Diagnóstico por Imagem</a></h4>
            <p>Exames com tecnologia moderna para diagnóstico preciso e ágil.</p>
            </div>
        </div><!-- End Service Item -->
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
            ...
            <h4><a href="" class="stretched-link">Genética e Biomedicina</a></h4>
            <p>Serviços laboratoriais com análise genética e precisão biomédica.</p>
            </div>
        </div><!-- End Service Item -->
    ...
    <div class="container">
        ...
        <div class="col-xl-10">
            <div class="text-center">
                <h3>Emergência médica? Precisa de ajuda agora?</h3>
                <p>Nossa equipe está disponível para atendimentos de urgência. Ligue ou agende uma consulta imediatamente.</p>
                <a class="cta-btn" href="#appointment">Agendar Consulta</a>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
            ...
            <p>Há mais de 15 anos cuidando de famílias com responsabilidade e compromisso com a saúde.</p>
            <h3>Cuidamos de você em todas as etapas da vida</h3>
            <p class="fst-italic">Nossa missão é promover saúde com excelência técnica e atenção humanizada.</p>
            <ul>
            <li>Equipe multidisciplinar altamente qualificada.</li>
            <li>Ambiente acolhedor e infraestrutura moderna.</li>
            <li>Agilidade no atendimento e foco no bem-estar.</li>
            </ul>
        </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-lg-3 col-md-6">
            ...
            <div>
                ...
                <p>Fisioterapia e Reabilitação</p>
            </div>
            </div>
        </div><!-- End Stats Item -->
